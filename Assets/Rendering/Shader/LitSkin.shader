Shader "CustomRender/LitSkin"
{
    Properties
    {
        ...
        _CurvatureScale("Curvature Scale (0.0 - 1.0)", Range(0.01, 5)) = 1

        // Shadow LUT
		[NoScaleOffset] _ShadowTex_LUT("Shadow LUT", 2D) = "black" {}
		_SkinShadowBias("ShadowBias", Vector) = (1, 0, 0, 0)
		...
		_DiffuseEnvironmentAmount("Diffuse Environment Amount", Range(0, 1)) = 1

		// Specular IBL
		[NoScaleOffset] _SpecularEnvironment("Specular Environment (IBL)", CUBE) = "" {}
		_SpecularEnvironmentAmount("Specular Environment Amount", Range(0, 1)) = 0.01
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma shader_feature_local FORWARD_BASE_PASS
            ...
            #pragma multi_compile_vertex _ GroundRollOnlyZ
            ...
            #pragma vertex SkinLitPassVertex
            #pragma fragment SkinLitPassFragment
